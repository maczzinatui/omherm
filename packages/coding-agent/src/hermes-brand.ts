// Hermes product branding for omherm path. Call before any OMP UI import.
// Identity: Hermes. Coat: OMP/pi-tui chrome (internal only).

export const PRODUCT_NAME = "hermes"
export const PRODUCT_CLI = "omh"
export const PRODUCT_VERSION =
  process.env.OMHERM_VERSION || process.env.MESHINA_TUI_VERSION || "0.1.0-hermes"
